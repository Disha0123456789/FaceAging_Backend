...
mask_file = torch.from_numpy(np.array(Image.open(os.path.join(assets_dir, 'mask1024.jpg')).convert('L'))) / 255
small_mask_file = torch.from_numpy(np.array(Image.open(os.path.join(assets_dir, 'mask512.jpg')).convert('L'))) / 255
