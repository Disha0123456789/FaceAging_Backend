...
# Add the face_reaging directory to the sys.path to include the model and scripts packages
script_dir = os.path.dirname(os.path.abspath(__file__))
face_reaging_dir = os.path.join(script_dir, '..')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="../../face_re-aging/best_unet_model.pth", help="Path to the model")
